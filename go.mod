...
require (
	...
	github.com/ipfs/go-cid v0.4.1 // indirect; indirectgg
	...
	google.golang.org/grpc v1.63.2 // indirect; indireggct
	google.golang.org/protobuf v1.33.0 // indirect; indirggggect
